...
public class Vendedor {
   ...
   public Vendedor(){}
    ...
    public static void adicionaVendedores(){
        vendedoresCadastrados.add(new Vendedor("Milena","55762902838","milena.alcantara.2106@gmail.com"));
        vendedoresCadastrados.add(new Vendedor("Zefir","123456789","zefir.nere.alcantara@gmail.com"));
        vendedoresCadastrados.add(new Vendedor("Margarida","738485928264","meg.mesquita@gmail.com"));
    }
